        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            trailing: Icon(Icons.message,
                color: Colors.black12, size: 22.0), // 这里是致右的部分，左边用leading
          ...
          ListTile(
            ...
            trailing: Icon(Icons.favorite,
                color: Colors.black12, size: 22.0), // 这里是致右的部分
